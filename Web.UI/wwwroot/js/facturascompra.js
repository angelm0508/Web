$(function () {
    ...
    $(document).on('click', '#btnCancelarDocFacturaCompra', async function () {
        const entry = $(this).data('entry');
    ...
    $(document).on('click', '#btnGuardarFacturaCompra', async function () {
        ...
        if (!esEdicion) {
            ...
            const respuesta = await App.enviarJson('/FacturasCompra/Crear', 'POST', datos);
            if (!respuesta.resultado) {
                App.mostrarError(respuesta.mensaje);
                return;
            }
    ...
    function inicializarDetalle() {
        ...
        buscadorArticuloCod = App.autocompletar({
            ...
            endpoint: '/FacturasCompra/BuscarArticulosPorCodigo',
    ...
    async function aplicarAlmacenDefectoDeArticulo(a) {
        ...
        const r = await $.get('/FacturasCompra/ObtenerAlmacenPorCodigo', { codigo: cod });
